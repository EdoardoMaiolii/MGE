...
public final class BracketsUtility {
     ...
     * return (int) str.chars().mapToObj(i->(char)
     * i).filter(i->i.equals(c)).count(); }
     */
    ...
    public static int endBracket(final String str, final int offset) { // return the close Bracket of the first openBracket
                                                                 // instance
